...
export const startReading = async (objectDOM) => {
  ...
  // for (const word of state.excercise.reading.words) {
  ...
  //   /// Az aktuális szópár kikerül a listából!!!
  //   //let index = state.excercise.reading.words.indexOf(word);
  //   //state.excercise.reading.words.splice(index, 1);
  //   //console.log(state.excercise.reading.words);
  //   // state.excercise.reading.words.p
  //   ///

  // }


  return state.excercise.reading.words;
...
var fruits = [
  { text: 'alma', language: 0 },
  { text: 'körte', language: 0 },
  { text: 'meggy', language: 0 },
  { text: 'barack', language: 0 },
  { text: 'dinnye', language: 0 },
  { text: 'szőlő', language: 0 },
  { text: 'szilva', language: 0 },
]
